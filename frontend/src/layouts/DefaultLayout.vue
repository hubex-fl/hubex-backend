...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/variables/streams", label: "Streams",      icon: "M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zm9.75-2.625C12.75 9.879 13.254 9.375 13.875 9.375h2.25c.621 0 1.125.504 1.125 1.125v9.375c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V10.5zm-9.75 6C3 15.879 3.504 15.375 4.125 15.375h2.25", cap: "vars.read" },
    ],
  },
  {
    label: "Automation",
    items: [
      ...
      { to: "/executions",  label: "Executions",  icon: "M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z", cap: null, comingSoon: true },
    ],
  },
  {
    label: "Observability",
    items: [
      ...
      { to: "/trace-hub",    label: "Trace Hub",   icon: "M7.5 3.75H6A2.25 2.25 0 003.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0120.25 6v1.5m0 9V18A2.25 2.25 0 0118 20.25h-1.5m-9 0H6A2.25 2.25 0 013.75 18v-1.5M15 12a3 3 0 11-6 0 3 3 0 016 0z", cap: null, comingSoon: true },
      { to: "/correlation",  label: "Correlation", icon: "M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z", cap: null, comingSoon: true },
    ],
  },
  {
    label: "Admin",
    items: [
      ...
      { to: "/api-docs", label: "API Docs", icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z", cap: null },
