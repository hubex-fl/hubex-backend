...
const navGroups = computed<NavGroup[]>(() => [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/automations", label: t('nav.automations'), icon: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z", cap: null },
    ],
  },
  {
