...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/audit",        component: () => import("./pages/Audit.vue"),           meta: { title: "Audit Log", feature: "audit_log" } },
    // Correlation removed — merged into TraceTimeline
    { path: "/observability",component: () => import("./pages/Observability.vue"),   meta: { title: "Observability", feature: "observability" } },
    { path: "/settings",     component: () => import("./pages/Settings.vue"),        meta: { title: "Settings" } },
    { path: "/settings/auth", redirect: "/settings" },
    { path: "/settings/types", component: () => import("./pages/SemanticTypes.vue"), meta: { title: "Semantic Types", feature: "semantic_types" } },
    { path: "/setup",        component: () => import("./pages/SetupWizard.vue"),    meta: { title: "Setup", fullscreen: true } },
    { path: "/disabled",     component: () => import("./pages/FeatureDisabled.vue"), meta: { title: "Feature Disabled" } },
    ...
    { path: "/pairing",      component: () => import("./pages/Pairing.vue"),         meta: { title: "Pairing", feature: "pairing" } },
    { path: "/system-health", component: () => import("./pages/SystemHealth.vue"),   meta: { title: "System Health" } },
    { path: "/automations",  component: () => import("./pages/Automations.vue"),     meta: { title: "Automations", feature: "automations" } },
    { path: "/developer",    component: () => import("./pages/ApiDocs.vue"),         meta: { title: "API Docs" } },
    { path: "/webhooks",     component: () => import("./pages/Webhooks.vue"),        meta: { title: "Webhooks", feature: "webhooks" } },
    { path: "/email-templates", component: () => import("./pages/EmailTemplates.vue"), meta: { title: "Email Templates", feature: "email_templates" } },
    { path: "/admin",          component: () => import("./pages/AdminConsole.vue"),   meta: { title: "Admin Console" } },
    { path: "/custom-api",    component: () => import("./pages/CustomApiBuilder.vue"), meta: { title: "Custom API", feature: "custom_api" } },
    ...
    { path: "/plugins/:key/embed", component: () => import("./pages/PluginEmbed.vue"), meta: { title: "Plugin", feature: "plugins", fullscreen: true } },
    ...
    { path: "/mcp",           component: () => import("./pages/McpServer.vue"),      meta: { title: "MCP Server", feature: "mcp" } },
    { path: "/flow-editor",   component: () => import("./pages/FlowEditor.vue"),     meta: { title: "Flow Editor", fullscreen: true, feature: "flow_editor" } },
    ...
    // CMS
    { path: "/cms",            component: () => import("./pages/CmsPages.vue"),       meta: { title: "CMS Pages", feature: "cms" } },
    { path: "/cms/forms",      component: () => import("./pages/CmsForms.vue"),       meta: { title: "CMS Forms", feature: "cms" } },
    { path: "/cms/forms/:id/edit", component: () => import("./pages/CmsFormEditor.vue"), meta: { title: "Edit Form", feature: "cms" } },
    { path: "/cms/forms/:id/submissions", component: () => import("./pages/CmsFormSubmissions.vue"), meta: { title: "Form Submissions", feature: "cms" } },
    { path: "/cms/menus",      component: () => import("./pages/CmsMenus.vue"),       meta: { title: "CMS Menus", feature: "cms" } },
    { path: "/cms/menus/:id/edit", component: () => import("./pages/CmsMenuEditor.vue"), meta: { title: "Edit Menu", fullscreen: true, feature: "cms" } },
    { path: "/cms/media",      component: () => import("./pages/CmsMedia.vue"),       meta: { title: "Media Library", feature: "cms" } },
    { path: "/cms/redirects",  component: () => import("./pages/CmsRedirects.vue"),   meta: { title: "URL Redirects", feature: "cms" } },
    { path: "/cms/settings",   component: () => import("./pages/SiteSettings.vue"),   meta: { title: "Site Settings", feature: "cms" } },
    { path: "/cms/:id/edit",   component: () => import("./pages/CmsPageEditor.vue"),  meta: { title: "Edit Page", fullscreen: true, feature: "cms" } },
    { path: "/cms/:slug/view", component: () => import("./pages/CmsPageView.vue"),    meta: { title: "View Page", fullscreen: true, feature: "cms" } },
