...
const onboardingSteps: TourStep[] = [
  ...
  {
    id: "sidebar-groups",
    target: "aside, nav, [class*='sidebar']",
    action: "spotlight",
    position: "right",
    title: "tours.onboarding.steps.sidebarGroups.title",
    text: "tours.onboarding.steps.sidebarGroups.text",
  },
  {
    id: "search",
    target: "[data-tour='search'], .search-trigger, button:has(kbd)",
    action: "spotlight+pulse",
    position: "bottom",
    title: "tours.onboarding.steps.search.title",
    text: "tours.onboarding.steps.search.text",
  },
  {
    id: "theme-toggle",
  ...
  {
    id: "language",
    target: "[data-tour='user-menu'], .user-avatar-btn",
    action: "spotlight+pulse",
    position: "bottom",
    title: "tours.onboarding.steps.language.title",
    text: "tours.onboarding.steps.language.text",
  },

  /* ── Phase B: Deine Daten sind schon da (4 steps) ────────────────────── */
  {
    id: "dashboard-kpis",
    page: "/",
    target: ".grid.grid-cols-2, .grid.grid-cols-4",
    action: "spotlight",
    position: "bottom",
  ...
  },
  {
    id: "variables",
    page: "/variables",
    target: ".vars-table-wrap, table, main",
    action: "spotlight",
    position: "bottom",
  ...
  /* ── Phase C: Was du tun kannst (5 steps) ────────────────────────────── */
  {
    id: "dashboards",
    page: "/dashboards",
    target: "h1, main",
  ...
  /* ── Phase D: Hilfe & Feedback (4 steps) ─────────────────────────────── */
  {
    id: "info-icons",
    action: "info",
    position: "center",
  ...
  {
    id: "feedback",
    target: "[data-tour='feedback-button'], .feedback-btn",
    action: "spotlight+pulse",
    position: "left",
...
export const onboardingTour: TourDefinition = {
  ...
  category: "builtin",
  autoplay: true,
  // 30s base — actual per-step timing calculated by calcStepDuration() in tour-engine.ts
