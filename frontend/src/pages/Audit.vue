    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
        <div class="flex items-center gap-2">
          <svg class="h-5 w-5 text-[var(--text-muted)]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
          ...
          <UInfoTooltip :title="t('infoTooltips.audit.title')" :items="tm('infoTooltips.audit.items').map((i: any) => rt(i))" tourId="getting-started" />
        </div>
