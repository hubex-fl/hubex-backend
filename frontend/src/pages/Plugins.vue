  ...
  <div class="space-y-6">
    <div class="flex items-start justify-between gap-4">
      <div>
        ...
        <p class="text-xs text-[var(--text-muted)] mt-0.5">Extend HUBEX with custom plugins — capability-gated, sandboxed execution</p>
      </div>
    ...
    <UEmpty v-else-if="!plugins.length"
      ...
      description="Plugins extend HUBEX with custom logic, integrations, and automation hooks."
