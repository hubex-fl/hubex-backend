...
Wenn für eine Route keine Capability definiert ist → 403.

Capabilities werden vor dem Handler geprüft (kein „best effort“, kein UI-hide).

5.4 „Public Routes“ (Whitelist, keine Grauzone)
...
Hinweis: „public“ bedeutet auth-free, aber nicht „capability-frei“ außerhalb der Whitelist.

5.5 Subject → Capabilities (Dokumentations-Tabelle, minimal)
...
(Weitere Zuordnungen nur ergänzend, ohne effects.invoke:*)
...
Token-Revoke wird serverseitig unterstützt via jti denylist oder token_version-Mechanismus.
...
2025-12-24 | 5, 11 | Add | Capabilities Enforcement präzisiert (deny-by-default + public whitelist); Token revoke (jti denylist/token_version) ergänzt
